...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   map_parsing_utils3_bonus.c                         :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hyunjuyo <hyunjuyo@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/10 12:47:26 by hyunjuyo          #+#    #+#             */
/*   Updated: 2021/04/10 13:08:49 by hyunjuyo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    do_check(t_game *game, char *img_path, char *type)
{
	...
	temp.img = mlx_xpm_file_to_image(game->mlx, img_path, &temp.width, &temp.height);
	if (!temp.img)
	{
...
void    img_file_open_check(t_game *game)
{
    ...
    img_path = game->conf.sprite[1];
    do_check(game, img_path, "S2");
    img_path = game->conf.sprite[2];
    do_check(game, img_path, "S3");
}
